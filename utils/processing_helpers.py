...
def process_claim(
    ...
    email_args.html_content = """
    <p> Hello, </p>
    <p>You are receiving this email because we need more information from you about your benefits case.</p>
    <p>You reported that you were not able or available to work for at least one week during which you were paid unemployment benefits.</p>
    <p>We would like to verify that information. And, if you were indeed not able or available to work at some point, we would like to better understand why.</p>
    <p>Please respond by September 30. Not responding by September 30 or responding untruthfully may negatively impact your benefits.</p>
    <p><a href='{}'>Fill out the form</a></p>
    <p>Thank you,</p>
    <p>The VT Department of Labor</p>""".format(
        claim.form_url
    )
